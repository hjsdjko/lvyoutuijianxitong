    ...
    */
    ...
    public R save(@RequestBody LvyouluxianEntity lvyouluxian, HttpServletRequest request){
        ...
        Wrapper<LvyouluxianEntity> queryWrapper = new EntityWrapper<LvyouluxianEntity>()
            ...
            .eq("zan_number", lvyouluxian.getZanNumber())
            .eq("cai_number", lvyouluxian.getCaiNumber())
            ;
...
//                            lvyouluxianEntity.setZanNumber(Integer.valueOf(data.get(0)));   //赞 要改的
//                            lvyouluxianEntity.setCaiNumber(Integer.valueOf(data.get(0)));   //踩 要改的
